...
public class TrainingDescriptionSectionItemView: UITableViewCell {
    // MARK: - Properties
    ...
    // MARK: - Main Interface
    public func configire(with model: TrainingDescriptionView.ItemViewModel, delegate: TPExerciseItemContentViewDelegate?, userData: [AnyHashable: Any]?) {
