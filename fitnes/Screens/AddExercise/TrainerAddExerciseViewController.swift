...
//        setupTableView()
    ...
    private func configureSegmnetedControl() {
        ...
        segmentedControl.insertSegment(withTitle: "AMRAP", at: 0, animated: true)
        segmentedControl.insertSegment(withTitle: "EMOM", at: 1, animated: true)
        segmentedControl.insertSegment(withTitle: "FOR TIME", at: 2, animated: true)
        segmentedControl.insertSegment(withTitle: "RESR", at: 3, animated: true)
        
        scrollView.addSubview(segmentedControl)
        segmentedControl.translatesAutoresizingMaskIntoConstraints = false
        segmentedControl.topAnchor.constraint(equalTo: scrollView.topAnchor, constant: 40).isActive = true
    ...
    @objc private func showDirection(segmentedControl: UISegmentedControl) {
